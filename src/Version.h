...
#define VERSION_NUM				1,4,1,0
#define VERSION_LINEAR			1410
#define VERSION_LINEAR_TEXT		TEXT("1410")
#define VERSION_TEXT			TEXT("1.4.1") // This must match the tag pushed on the server minus the "v"
